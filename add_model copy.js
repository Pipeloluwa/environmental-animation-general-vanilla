...
function animate(event){
    ...
    // else if(intersects.length ===  0 && lastObject !== null){
    //     lastObject.material.color.set(new THREE.Color(0, 0, 0)); //RESETIING COLOR TO NEUTRAL
    //     lastObject= null;
    // }


    // // TO CHECK IF THE MOUSE MOVE OR NOT
    // if (lastMousePosition.distanceTo(mousePosition) > 0.001){
